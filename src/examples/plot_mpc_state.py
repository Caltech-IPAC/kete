...
states = apohele.propagate_two_body(states, states[0].jd)
...
for state in states:
    ...
    pos = np.array([apohele.propagate_two_body([state], jd)[0].pos for jd in jds]).T
