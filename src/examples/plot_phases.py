...
neos = apohele.mpc.table_to_states(neo_subset)
...
jd = apohele.Time.from_iso("2024-07-03T23:11:42.748000+00:00").jd
...
# want more precision.
sun2earth = apohele.spice.get_state("Earth", jd).pos
states = apohele.propagate_two_body(neos, jd)
