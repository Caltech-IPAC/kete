...
_WISE_URL = "https://irsa.ipac.caltech.edu/ibe/data/wise/"
"""Base URL for all WISE/NEOWISE frames"""
...
MISSION_PHASES = {
    "Cryo": MissionPhase(
        ...
        bands=(1, 2, 3, 4),
        frame_url=_WISE_URL + "allsky/4band_p1bm_frm/",
    ...
    "3-Band": MissionPhase(
        ...
        bands=(1, 2, 3),
        frame_url=_WISE_URL + "cryo_3band/3band_p1bm_frm/",
    ...
    "Post-Cryo": MissionPhase(
        ...
        bands=(1, 2),
        frame_url=_WISE_URL + "postcryo/2band_p1bm_frm/",
    ...
    "Reactivation_2014": MissionPhase(
        ...
        bands=(1, 2),
        frame_url=_WISE_URL + "neowiser/p1bm_frm/",
