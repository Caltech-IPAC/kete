...
This may be either set by the environmental variable `apohele_CACHE_DIR` or
by changing this variable after importing apohele.
"""
...
def cache_path(subfolder=""):
    ...
    The cache folder contains files which are downloaded during use of apohele and
...
def cache_ls(subfolder=""):
    """List the contents of the apohele cache directory"""
