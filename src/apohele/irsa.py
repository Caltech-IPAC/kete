...
def query_irsa_tap(
    ...
    .. testcode::
        ...
        jd = apohele.Time.from_mjd(56823.933738).jd

        # This time corresponds to this phase:
        phase = apohele.wise.mission_phase_from_jd(jd)

        # Single source table on IRSA is then: phase.source_table

        # The columns of data available in this source table are
        column_information = apohele.irsa.IRSA_column_data(phase.source_table)
        ...
        result = apohele.irsa.query_irsa_tap(query, upload_table=data)
