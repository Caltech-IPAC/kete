use apohele_core::errors::Error;
use apohele_core::io::FileIO;
use apohele_core::simult_states::SimultaneousStates;
use pyo3::exceptions;
use pyo3::prelude::*;
...
///
#[pyclass(module = "apohele", frozen, sequence, name = "SimultaneousStates")]
#[derive(Debug)]
