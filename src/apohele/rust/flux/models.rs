...
#[pyclass(frozen, module = "apohele.flux", name = "ModelResults")]
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct PyModelResults(pub apohele_core::flux::ModelResults);

impl From<apohele_core::flux::ModelResults> for PyModelResults {
    fn from(value: apohele_core::flux::ModelResults) -> Self {
        Self(value)
    }
}
...
impl PyModelResults {
    ...
    pub fn new(
        ...
        apohele_core::flux::ModelResults {
            fluxes,
            magnitudes,
            thermal_fluxes,
            hg_fluxes,
    ...
    pub fn py_load(filename: String) -> PyResult<Self> {
        Ok(Self(apohele_core::flux::ModelResults::load(filename)?))
    }
    ...
    pub fn py_save_list(vec: Vec<Self>, filename: String) -> PyResult<()> {
        ...
        Ok(apohele_core::flux::ModelResults::save_vec(&vec, filename)?)
    }
    ...
    pub fn py_load_list(filename: String) -> PyResult<Vec<Self>> {
        let res = apohele_core::flux::ModelResults::load_vec(filename)?;
...
#[pyclass(frozen, module = "apohele.flux", name = "NeatmParams")]
#[derive(Clone, Debug)]
pub struct PyNeatmParams(pub apohele_core::flux::NeatmParams);

impl From<apohele_core::flux::NeatmParams> for PyNeatmParams {
    fn from(value: apohele_core::flux::NeatmParams) -> Self {
        Self(value)
    }
}
...
impl PyNeatmParams {
    ...
    pub fn new(
        ...
        Ok(apohele_core::flux::NeatmParams {
            obs_bands,
            beaming,
            band_albedos,
            hg_params,
    ...
    pub fn new_wise(
        ...
        let band_albedos = match band_albedos.try_into() {
            Ok(v) => v,
            Err(_) => Err(apohele_core::errors::Error::ValueError(
                "4 Albedos must be provided, one for each WISE band.".into(),
            ))?,
        };
        Ok(
            apohele_core::flux::NeatmParams::new_wise(band_albedos, beaming, hg_params, emissivity)
                .into(),
        )
    }
    ...
    pub fn new_neos(
        ...
        Ok(
            apohele_core::flux::NeatmParams::new_neos(band_albedos, beaming, hg_params, emissivity)
                .into(),
        )
    }
    ...
    #[pyo3(name = "load")]
    pub fn py_load(filename: String) -> PyResult<Self> {
        Ok(Self(apohele_core::flux::NeatmParams::load(filename)?))
    }
    ...
    pub fn py_save_list(vec: Vec<Self>, filename: String) -> PyResult<()> {
        let vec: Vec<_> = vec.into_iter().map(|x| x.0).collect();
        Ok(apohele_core::flux::NeatmParams::save_vec(&vec, filename)?)
    }
    ...
    #[pyo3(name = "load_list")]
    pub fn py_load_list(filename: String) -> PyResult<Vec<Self>> {
        let res = apohele_core::flux::NeatmParams::load_vec(filename)?;
        Ok(res.into_iter().map(Self).collect())
    }
}
...
/// zero_mags:
///     Optional - If zero mags are provided then magnitudes may be computed.
#[pyclass(frozen, module = "apohele.flux", name = "FrmParams")]
#[derive(Clone, Debug)]
pub struct PyFrmParams(pub apohele_core::flux::FrmParams);

impl From<apohele_core::flux::FrmParams> for PyFrmParams {
    fn from(value: apohele_core::flux::FrmParams) -> Self {
        Self(value)
    }
}
...
impl PyFrmParams {
    ...
    pub fn new(
        ...
        Ok(apohele_core::flux::FrmParams {
            obs_bands,
            band_albedos,
            hg_params,
            emissivity,
    ...
    pub fn new_wise(
        ...
        Ok(apohele_core::flux::FrmParams::new_wise(band_albedos, hg_params, emissivity).into())
    }
    ...
    pub fn new_neos(
        ...
        Ok(apohele_core::flux::FrmParams::new_neos(band_albedos, hg_params, emissivity).into())
    }
    ...
    #[pyo3(name = "load")]
    pub fn py_load(filename: String) -> PyResult<Self> {
        Ok(Self(apohele_core::flux::FrmParams::load(filename)?))
    }
    ...
    pub fn py_save_list(vec: Vec<Self>, filename: String) -> PyResult<()> {
        let vec: Vec<_> = vec.into_iter().map(|x| x.0).collect();
        Ok(apohele_core::flux::FrmParams::save_vec(&vec, filename)?)
    }
    ...
    #[pyo3(name = "load_list")]
    pub fn py_load_list(filename: String) -> PyResult<Vec<Self>> {
        let res = apohele_core::flux::FrmParams::load_vec(filename)?;
        Ok(res.into_iter().map(Self).collect())
    }
}
