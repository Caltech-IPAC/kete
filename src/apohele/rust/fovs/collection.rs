...
impl FOVListLike {
    /// Convert to a vector of apohele core fovs.
    /// Frames will always be ecliptic
    pub fn into_sorted_vec_fov(self) -> Vec<apohele_core::fov::FOV> {
...
#[pyclass(module = "apohele", sequence)]
#[derive(Debug, Clone)]
...
impl FOVList {
    ...
    fn save(&self, filename: String) -> PyResult<()> {
        ...
        let fovs: Vec<apohele_core::fov::FOV> =
