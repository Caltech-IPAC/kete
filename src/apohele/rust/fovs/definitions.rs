...
use apohele_core::fov::{self, NeosBand};
use apohele_core::fov::{FovLike, SkyPatch};
...
#[pyclass(module = "apohele", frozen, name = "WiseCmos")]
#[derive(Clone, Debug)]
#[allow(clippy::upper_case_acronyms)]
pub struct PyWiseCmos(pub fov::WiseCmos);

/// Field of view of a NEOS CMOS chip.
#[pyclass(module = "apohele", frozen, name = "NeosCmos")]
#[derive(Clone, Debug)]
#[allow(clippy::upper_case_acronyms)]
