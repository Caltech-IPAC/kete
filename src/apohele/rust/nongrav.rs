use apohele_core::{errors::Error, propagation::NonGravModel};
...
///
#[pyclass(frozen, module = "apohele.propagation", name = "NonGravModel")]
#[derive(Debug, Clone)]
    ...
    pub fn __repr__(&self) -> String {
        match self.0 {
            NonGravModel::Dust { beta} => format!(
                "apohele.propagation.NonGravModel.new_dust(beta={:?})",
                beta
            ),
            NonGravModel::JplComet {
                ...
                "apohele.propagation.NonGravModel.new_comet(a1={:?}, a2={:?}, a3={:?}, alpha={:?}, r_0={:?}, m={:?}, n={:?}, k={:?})",
