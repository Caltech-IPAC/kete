...
def _year_float(self) -> float:
    ...
    >>> apohele.Time.from_ymd(2010, 1, 1).year_float
    2010.0

    >>> apohele.Time(2457754.5, scaling='utc').year_float
    2017.0

    2016 was a leap year, so 366 days instead of 365.

    >>> apohele.Time(2457754.5 - 366, scaling='utc').year_float
    2016.0
    """
...
def _local_time(self, timezone=None) -> str:
    ...
    timezone:
        ...
        python maintains a list of pre-defined timezones:
            ...
            apohele.Time.j2000().local_time(timezone)
...
def d_h_m_s_to_float_days(
    ...
    >>> apohele.time.d_h_m_s_to_float_days(1, 11, 59, 60)
    1.5
...
def days_in_year(year: int) -> int:
    ...
    >>> apohele.time.days_in_year(2016)
    366

    >>> apohele.time.days_in_year(2017)
    365
