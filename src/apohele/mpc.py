...
def find_obs_code(name: str):
    ...
    >>> apohele.mpc.find_obs_code("Palomar Mountain")
...
def num_to_base62(n: int, base_len=6) -> str:
    ...
    >>> apohele.mpc.num_to_base62(63, 3)
    '011'
...
def unpack_permanent_designation(designation):
    ...
    >>> apohele.mpc.unpack_permanent_designation("~AZaz")
    '3140113'
    >>> apohele.mpc.unpack_permanent_designation("C3456")
    '123456'
    >>> apohele.mpc.unpack_permanent_designation("0021P")
    '21P'
    >>> apohele.mpc.unpack_permanent_designation("J005S")
    'Jupiter V'
...
def pack_permanent_designation(unpacked):
    ...
    >>> apohele.mpc.pack_permanent_designation('3140113')
    '~AZaz'
    >>> apohele.mpc.pack_permanent_designation('21P')
    '0021P'
    >>> apohele.mpc.pack_permanent_designation('Saturn V')
    'S005S'
...
def unpack_provisional_designation(packed: str):
    ...
    >>> apohele.mpc.unpack_provisional_designation("J98SA8Q")
    '1998 SQ108'
...
def pack_provisional_designation(unpacked: str):
    ...
    >>> apohele.mpc.pack_provisional_designation("1998 SQ108")
    'J98SA8Q'
...
def pack_satellite_designation(unpacked: str):
    ...
    >>> apohele.mpc.pack_satellite_designation("Jupiter XIII")
    'J013S'
...
def unpack_satellite_designation(packed: str):
    ...
    >>> apohele.mpc.unpack_satellite_designation("J013S")
    'Jupiter XIII'
...
def pack_comet_designation(unpacked: str):
    ...
    >>> apohele.mpc.pack_comet_designation("C/2020 F3")
    'CK20F030'

    >>> apohele.mpc.pack_comet_designation("1P/Halley")
    '0001P'
...
def unpack_comet_designation(packed: str):
    ...
    >>> apohele.mpc.unpack_comet_designation("CI70Q010")
    'C/1870 Q1'
...
def unpack_designation(packed: str):
    ...
    >>> apohele.mpc.unpack_designation("J98SA8Q")
    '1998 SQ108'

    >>> apohele.mpc.unpack_designation("~AZaz")
    '3140113'
...
def pack_designation(unpacked: str):
    ...
    >>> apohele.mpc.pack_designation("1998 SQ108")
    'J98SA8Q'

    >>> apohele.mpc.pack_designation("3140113")
    '~AZaz'
...
def mpc_known_orbit_filtered(filt):
    ...
    filt:
        ...
        See `apohele.population` for a collection of filter functions which
...
def table_to_states(orbit_dataframe):
    ...
    .. testcode::
        ...
        # Load all MPC orbits
        orbits = apohele.mpc.fetch_known_orbit_data()

        # Subset the table to be only NEOs
        neos = apohele.population.neo(orbits.peri_dist, orbits.ecc)
        neo_subset = orbits[neos]

        # load the state object from this table
        state = apohele.mpc.table_to_states(neo_subset)
...
class MPCObservation:
    ...
    .. testcode::
        ...
        observations = apohele.mpc.MPCObservation.from_lines(lines)
